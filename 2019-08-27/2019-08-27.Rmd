...
simpsons_merged %>% 
 ...
 geom_text(data = . %>% mutate(avg_viewers = avg_viewers+0.3),aes(label = avg_rating,y=avg_viewers),family = "Akbar")+
      annotate("text", x = 16, y = 7, label = 'The lowest IMDB rating among\n all guest stars goes to "Lady Gaga"\n for "Lisa Goes Gaga" episode ', family = "Akbar", size = 5,vjust = 0.5,hjust = 0.6) +
